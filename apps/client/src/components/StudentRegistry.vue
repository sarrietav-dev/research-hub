          ...
          <v-card-text>
            <v-container>
              ...
              <v-row>
                ...
                <v-row>
                    <v-col cols="6">
                        <v-text-field v-model="codigoInstitucional" type="number" label="Codigo institucional" variant="outlined" :hide-details="true"/>
                    </v-col>
                    <v-col cols="6">
                        <v-select v-model="selectedProgram" :items="programsList" label="Programa" item-value="id" item-title="name" variant="outlined" :hide-details="true"/>
                    </v-col>
                </v-row>
            </v-container>
          </v-card-text>
